...
while True:
    ...
    options.add_argument('window-size=1920x1080')  #'window-size=800x600'

    driver = webdriver.Chrome(ChromeDriverManager(version=chrome_version).install(),chrome_options=options)   #-----------------
